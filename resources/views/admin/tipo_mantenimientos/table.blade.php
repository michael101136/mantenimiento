            ...
            <td>{!! $tipoMantenimiento->siglas !!}</td>
                <td>
                    ...
                    <div class='btn-group'>
                        ...
                        {!! Form::button('<i class="glyphicon glyphicon-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'onclick' => "return confirm('desea eliminar el  tipo de mantenimiento?')"]) !!}
                    </div>
                    {!! Form::close() !!}
                </td>
            </tr>
