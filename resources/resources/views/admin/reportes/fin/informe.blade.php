...
<div id="contenido">
  ...
  <div id="cabecera">
      ...
      <div>N° 003  -<?php    $fecha= date ("Y"); echo $fecha;  ?>   </div>
  </div>
  <hr/>
...
¿
    ...
    <div id="cabecera1">ADJUNTA IMAGEN DE INICIO DEL PROCESO (PROBLEMA)</div><br/>
       ...
       <br>  <br>  <br>
        <div id="cabecera1">INFORME Y ESTADO DEL TRABAJO CULMINADO</div><br/>
        ...
        <br><br>
        <div id="cabecera1">ADJUNTA IMAGEN DEL FIN DEL PROCESO </div><br/>
        <table id="tabladata2" WIDTH="90%">
