...
<div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              ...
              <h3>LISTADO DE PROBLEMAS <small></small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                        <a href="{{('/crearproblemas')}}" class="btn btn-success "><i class="fa fa-plus-circle"> NUEVO   </i></a>
                    ...
                    <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr style="text-transform: uppercase;">
                          ...
                          <td><button type="button" class="btn btn-success" onclick="imagen({{$item->id}})"><span class="glyphicon glyphicon-camera"></span></button></td>
